...
Below are the client-specific methods for configuration:
...
<Tabs
  ...
  buttons={[
    ...
    { name: "Kakoune", image: "/images/kakoune.svg", accent: "#ffffff" },
  ]}
>
  <div data-tab="VS Code">
    ...
    Other settings like [`workspace.library`](/wiki/settings#workspace-library) *should* be workspace only.
  ...
  <Accordion>
    <span slot="summary">Using built-in LSP client</span>
  ...
  <Accordion>
    <span slot="summary">Using [coc.nvim](https://github.com/neoclide/coc.nvim)</span>
  ...
  <div data-tab="Kakoune">
    <Accordion>
      <span slot="summary">Using [kak-lsp](https://github.com/kak-lsp/kak-lsp)</span>
