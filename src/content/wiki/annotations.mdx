...
<Remark type="warning" compact={true}>
...
Define a class. Can be used with [`@field`](#field) to define a table structure. Once a class is defined, it can be used as a type for [parameters](#param), [returns](#return), and more. A class can also inherit from a parent class.
...
{/* prettier-ignore */}
<div class="syntax"><code>---@diagnostic &lt;state&gt;:&lt;[diagnostic](/wiki/diagnostics/)&gt;</code></div>
