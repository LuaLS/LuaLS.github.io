...
import { faCircle, faShapes } from "@fortawesome/free-solid-svg-icons";
...
<Tabs
  active="Simple"
  buttons={[
    { name: "Simple", icon: faCircle, accent: "#00ff00" },
    { name: "Enum", icon: faShapes, accent: "#ff8800" },
  ]}
>
  <div data-tab="Simple">
    <div class="syntax">
...
<div class="syntax">
  {/* prettier-ignore */}
  `---@overload fun([param: type[, param: type...]]):
